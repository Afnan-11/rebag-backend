...
import exceptionHandler from "./middleware/exception.middleware.js";
import globalExceptionHandler from "./utilis/globalErrorHandler.util.js";
import IP from "./utilis/ip.util.js";
...
const corsOptions = {
  ...
  origin: (origin, callback) => {
    console.log(originWhitelist.indexOf(origin), origin)
...
app.use((req, res, next) => {
  ...
  res.json = function json(response) {
    ...
    if (response?.success === false)
      console.log({ response, resHeaders: res.getHeaders() });
